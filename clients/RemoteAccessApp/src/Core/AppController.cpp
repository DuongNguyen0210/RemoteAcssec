...
<<<<<<<< HEAD:clients/RemoteAccessApp/src/Core/Controllers/appcontroller.cpp
...
>>>>>>>> origin/refactor-client-architecture-and-presence:clients/RemoteAccessApp/src/Core/AppController.cpp
