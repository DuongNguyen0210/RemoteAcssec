<<<<<<<< HEAD:clients/RemoteAccessApp/src/Core/Controllers/registercontroller.cpp
...
>>>>>>>> origin/refactor-client-architecture-and-presence:clients/RemoteAccessApp/src/Core/RegisterController.cpp
