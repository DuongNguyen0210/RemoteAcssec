<<<<<<<< HEAD:clients/RemoteAccessApp/src/Core/Controllers/authcontroller.cpp
...
>>>>>>>> origin/refactor-client-architecture-and-presence:clients/RemoteAccessApp/src/Core/AuthController.cpp
